 ...
 */
export function resolveStaleThreshold(meta, envOverride) {
 ...
 */
export function checkStaleness(meta, opts = {}) {
 ...
 */
export function checkAndEmitStaleWarning(meta, opts = {}) {
